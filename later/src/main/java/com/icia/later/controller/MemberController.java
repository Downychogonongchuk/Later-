...
public class MemberController {
	...
	public String mUpdateProc(@RequestPart List<MultipartFile> files, MemberDto member, HttpSession session,
	...
	public String emailcheck(@RequestParam("email") String email) {
		...
		try {
			isEmailUnique = mServ.isEmailUnique(email);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return String.valueOf(isEmailUnique);
	}
}
