...
<head>
	<meta charset="UTF-8">
	<title>아이디 찾기</title>
	<link rel="stylesheet" href="resources/css/mFindById.css">
...
<jsp:include page="header.jsp" />
	<div class="content">
		<form action="mFindByIdProc" method="post" enctype="multipart/form-data">
        ...
        <div class="result-section"><h4>${EmailResult.memberEmail}</h4></div>
